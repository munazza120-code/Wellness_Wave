...
<body>
    ...
    <div class="info-header">
        <h2>Muscle Health: Comprehensive Guide</h2>
        <p style="color: white;">Understanding, preventing, and managing muscle health for all age groups</p>
    </div>
    ...
    <div id="adults" class="age-content active">
        <div class="info-section">
            <h3>🔴 What Are They?</h3>
            <p>Muscle problems include pain, stiffness, cramps, or weakness. Causes can be overuse, injury, or lack of nutrients.</p>
        </div>
        
        <div class="info-section">
            <h3>⚠ Precautions</h3>
            <ul>
                <li>Avoid sudden heavy lifting or over-exercising.</li>
                <li>Take breaks during repetitive activities.</li>
                <li>Stay hydrated to prevent cramps.</li>
                <li>Warm up before exercise and cool down after.</li>
                <li>Use proper posture during work or sports.</li>
                <li>Avoid sleeping in uncomfortable positions.</li>
            </ul>
        </div>
        ...
        <div class="info-section">
            ...
            <div class="timing-plan">
                <div class="time-item">
                    ...
                    <p>Warm water with lemon or a pinch of salt (hydration and minerals)</p>
                </div>
                <div class="time-item">
                    <strong>8:00 – 8:30 AM | Breakfast:</strong>
                    <p>Protein-rich foods: eggs, milk, or yogurt<br>Whole grains like oats or whole wheat toast<br>Fresh fruits rich in potassium (banana, orange)</p>
                </div>
                <div class="time-item">
                    <strong>11:00 AM | Mid-Morning Snack:</strong>
                    <p>Nuts and seeds (almonds, pumpkin seeds)<br>Or a fruit like apple or pear</p>
                </div>
                <div class="time-item">
                    <strong>1:00 – 1:30 PM | Lunch:</strong>
                    <p>Lean protein: chicken, fish, or lentils<br>Vegetables: spinach, broccoli, carrots<br>Whole grains: brown rice or whole wheat roti</p>
                </div>
                <div class="time-item">
                    <strong>4:00 PM | Evening Snack:</strong>
                    <p>Herbal tea or coconut water<br>Light snack: roasted chickpeas or fruit</p>
                </div>
                <div class="time-item">
                    <strong>7:00 – 7:30 PM | Dinner:</strong>
                    <p>Light protein meal: soup with vegetables or khichdi<br>Avoid heavy, oily, or fried foods at night</p>
                </div>
                <div class="time-item">
                    <strong>Before Bed (Optional):</strong>
                    <p>Warm milk with turmeric (helps muscle recovery, 2–3 times a week)</p>
                </div>
            </div>
        </div>
        ...
        <div class="info-section">
            <h3>🏃 Exercises</h3>
            <ul>
                <li>Stretching daily to prevent stiffness</li>
                <li>Light strength training to build muscle</li>
                <li>Walking or swimming for gentle muscle work</li>
                <li>Avoid sudden, intense workouts without preparation</li>
            </ul>
        </div>
        ...
        <div class="info-section">
            <h3>🧴 DIY Remedies</h3>
            <ul>
                <li>Warm compress or heating pad on sore muscles</li>
                <li>Massage with mustard or olive oil to improve blood flow</li>
                <li>Drink ginger or turmeric tea for inflammation</li>
                <li>Epsom salt bath to relax muscles</li>
    ...
    <div id="children" class="age-content">
        <div class="info-section">
            <h3>🔴 What Are They?</h3>
            <p>Muscle problems in children can include pain, stiffness, or cramps from growth, activity, or nutritional deficiencies.</p>
        </div>
        
        <div class="info-section">
            <h3>⚠ Precautions for Children</h3>
            <ul>
                <li>Avoid carrying heavy backpacks.</li>
                <li>Encourage good posture while sitting and standing.</li>
                <li>Make sure children warm up before sports or physical play.</li>
                <li>Avoid sitting or standing in one position too long.</li>
                <li>Use comfortable, well-fitting shoes.</li>
                <li>Watch for complaints of pain or stiffness and consult a doctor if needed.</li>
            </ul>
        </div>
        ...
        <div class="info-section">
            ...
            <div class="timing-plan">
                ...
                <div class="time-item">
                    <strong>8:00 – 8:30 AM | Breakfast:</strong>
                    <p>Soft porridge or oatmeal with milk<br>Small handful of nuts (if no allergies)<br>Fresh fruit like banana or apple</p>
                </div>
                <div class="time-item">
                    <strong>11:00 AM | Mid-Morning Snack:</strong>
                    <p>Fresh fruit like orange, pear, or grapes<br>Or a handful of seeds (pumpkin or sunflower)</p>
                </div>
                <div class="time-item">
                    <strong>1:00 – 1:30 PM | Lunch:</strong>
        ...
        <div class="info-section">
            <h3>🏃 Exercises</h3>
            <ul>
                <li>Active play like running, cycling, or swimming for 30 minutes daily</li>
                <li>Gentle stretching or child-friendly yoga poses</li>
                <li>Avoid rough play causing injury</li>
                <li>Encourage breaks during long sitting times (school or screen time)</li>
            </ul>
        </div>
        ...
        <div class="info-section">
            <h3>🧴 DIY Remedies</h3>
            <ul>
                <li>Warm compress on sore muscles (use warm towel, not hot)</li>
                <li>Mild ginger tea (for kids over 5 years, once daily)</li>
                <li>Gentle massage with warm mustard or coconut oil</li>
                <li>Encourage plenty of water intake</li>
                <li>Keep muscles moving gently, no forced exercises</li>
            </ul>
        </div>
    </div>
    ...
    <div id="elderly" class="age-content">
        <div class="info-section">
            <h3>🔴 What Are They?</h3>
            <p>Muscle problems in older adults often include weakness, pain, or cramps due to aging, reduced activity, or nutritional deficiencies.</p>
        </div>
        
        <div class="info-section">
            <h3>⚠ Precautions for Older People</h3>
            <ul>
                <li>Avoid heavy lifting or sudden movements that may cause injury.</li>
                <li>Take breaks during physical activity to avoid muscle strain.</li>
                <li>Stay well hydrated to prevent cramps and weakness.</li>
                <li>Use supportive shoes and comfortable posture while sitting or walking.</li>
                <li>Avoid sleeping in positions that strain muscles.</li>
                <li>Consult a doctor early if muscle pain or weakness persists.</li>
            </ul>
        </div>
        ...
        <div class="info-section">
            ...
            <div class="timing-plan">
                <div class="time-item">
                    <strong>7:00 – 7:30 AM | Early Morning:</strong>
                    <p>Warm water with lemon or a pinch of salt (to balance electrolytes)</p>
                </div>
                <div class="time-item">
                    <strong>8:00 – 8:30 AM | Breakfast:</strong>
                    <p>Soft porridge or oatmeal with milk<br>Soaked almonds or walnuts (2-3 pieces)<br>Fresh fruit like banana or papaya (easy to digest and potassium-rich)</p>
                </div>
                <div class="time-item">
                    <strong>11:00 AM | Mid-Morning Snack:</strong>
                    <p>Small bowl of fruit salad or handful of seeds (flaxseeds, pumpkin seeds)</p>
                </div>
                <div class="time-item">
                    <strong>1:00 – 1:30 PM | Lunch:</strong>
                    <p>Soft whole wheat roti or brown rice<br>Cooked vegetables (spinach, carrots, bottle gourd)<br>Lentils or soft beans for protein<br>Small bowl of low-fat yogurt</p>
                </div>
                <div class="time-item">
                    <strong>4:00 PM | Evening Snack:</strong>
                    <p>Herbal tea (green tea or tulsi tea)<br>Light snack like roasted chana or fresh fruit</p>
                </div>
                <div class="time-item">
                    <strong>7:00 – 7:30 PM | Dinner:</strong>
                    <p>Light meal: vegetable soup, khichdi, or soft cooked vegetables with roti<br>Avoid fried, spicy, or heavy foods in the evening</p>
                </div>
                <div class="time-item">
                    <strong>Before Bed (Optional):</strong>
                    <p>Warm turmeric milk (1 cup, 2–3 times a week) to reduce muscle pain and inflammation</p>
                </div>
            </div>
        </div>
        ...
        <div class="info-section">
            <h3>🏃 Exercises</h3>
            <ul>
                <li>Gentle stretching daily to maintain flexibility</li>
                <li>Light strength exercises with very light weights or resistance bands</li>
                <li>Walking or swimming for overall muscle strength</li>
                <li>Avoid sudden or intense exercise without warming up</li>
            </ul>
        </div>
        ...
        <div class="info-section">
            <h3>🧴 DIY Remedies</h3>
            <ul>
                <li>Warm compress or heating pad on sore muscles to ease pain</li>
                <li>Massage with warm mustard or olive oil to improve circulation</li>
                <li>Drink ginger or turmeric tea regularly for anti-inflammatory benefits</li>
                <li>Epsom salt baths once a week to relax muscles</li>
