        ...
        <main class="content-area">
            ...
            <div class="info-container">
                <div class="info-header">
                    <h2>Hemorrhoids: Comprehensive Guide</h2>
                    <p  style="color: white;">Understanding, preventing, and managing hemorrhoids for all age groups</p>
                </div>
                ...
                <div id="adults" class="age-content active">
                    <div class="info-section">
                        <h3>🔴 What Are They?</h3>
                        <p>Hemorrhoids are swollen veins in the lower rectum or anus that cause pain, itching, and sometimes bleeding during bowel movements.</p>
                    </div>
                    ...
                    <div class="info-section">
                        ...
                        <ul>
                            ...
                            <li>Don't sit for long periods, especially on hard surfaces.</li>
                            <li>Keep the anal area clean and dry.</li>
                            <li>Avoid heavy lifting or intense physical strain.</li>
                            <li>Drink plenty of water to avoid constipation.</li>
                        </ul>
                    </div>
                    ...
                    <div class="info-section">
                        ...
                        <div class="timing-plan">
                            <div class="time-item">
                                ...
                                <p>A glass of warm water with soaked flaxseeds (helps bowel movement)</p>
                            </div>
                            <div class="time-item">
                                <strong>8:00 AM | Breakfast:</strong>
                                <p>Oatmeal with fruits like berries or apples (high fiber)<br>Herbal tea (chamomile or peppermint)</p>
                            </div>
                            <div class="time-item">
                                <strong>11:00 AM | Mid-Morning Snack:</strong>
                                <p>Fresh fruit (pear, orange) or a handful of soaked nuts</p>
                            </div>
                            <div class="time-item">
                                <strong>1:00 PM | Lunch:</strong>
                                <p>Brown rice or whole wheat chapati<br>Lentils or vegetable stew<br>Cooked greens (spinach, fenugreek)</p>
                            </div>
                            <div class="time-item">
                                <strong>4:00 PM | Evening Snack:</strong>
                                <p>Roasted chickpeas or seeds<br>Coconut water or herbal tea</p>
                            </div>
                            <div class="time-item">
                                <strong>7:00 PM | Dinner:</strong>
                                <p>Vegetable soup or khichdi<br>Light vegetable stir-fry</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="info-section">
                        <h3>🏃 Exercises</h3>
                        <ul>
                            <li>Gentle walking for 20–30 minutes daily</li>
                            <li>Pelvic floor exercises (Kegels)</li>
                            <li>Avoid heavy lifting or strenuous workouts</li>
                        </ul>
                    </div>
                    ...
                    <div class="info-section">
                        <h3>🧴 DIY Remedies</h3>
                        <ul>
                            <li>Sitz bath (warm water soak) for 15 mins, 2-3 times a day</li>
                            <li>Applying aloe vera gel to reduce itching and swelling</li>
                            <li>Use cold compress to reduce pain</li>
                            <li>Witch hazel pads to soothe irritation</li>
                            <li>Avoid scratching; keep the area clean with mild soap</li>
                        </ul>
                    </div>
                </div>
                ...
                <div id="children" class="age-content">
                    <div class="info-section">
                        <h3>👶 Hemorrhoids in Children</h3>
                        <p>Though rare, children can get hemorrhoids usually due to constipation, diarrhea, or sitting too long on the toilet.</p>
                    </div>

                    <div class="info-section">
                        <h3>⚠ Precautions</h3>
                        <ul>
                            <li>Avoid letting the child strain while passing stool.</li>
                            <li>Ensure they don't sit on the toilet for too long.</li>
                            <li>Keep the anal area clean and dry after bowel movements.</li>
                            <li>Encourage regular bathroom habits.</li>
                        </ul>
                    </div>
                    ...
                    <div class="info-section">
                        ...
                        <div class="timing-plan">
                            <div class="time-item">
                                ...
                                <p>A glass of warm water or diluted fruit juice (to soften stool)</p>
                            </div>
                            <div class="time-item">
                                <strong>8:30 AM | Breakfast:</strong>
                                <p>Whole grain cereal or oats<br>Fruit like banana or apple (fiber-rich and easy to digest)</p>
                            </div>
                            <div class="time-item">
                                <strong>11:00 AM | Snack:</strong>
                                <p>Soft fruits (pear, papaya) or yogurt</p>
                            </div>
                            <div class="time-item">
                                <strong>1:00 PM | Lunch:</strong>
                                <p>Lentil soup or soft cooked vegetables<br>Rice or chapati<br>A small salad with cucumber or carrots</p>
                            </div>
                            <div class="time-item">
                                <strong>4:00 PM | Snack:</strong>
                                <p>Roasted seeds (pumpkin, sunflower) or boiled sweet potato</p>
                            </div>
                            <div class="time-item">
                                <strong>7:00 PM | Dinner:</strong>
                                <p>Khichdi or vegetable soup<br>Steamed vegetables</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="info-section">
                        <h3>🏃 Exercises</h3>
                        <ul>
                            <li>Encourage active play or walking for 30 minutes daily</li>
                            <li>Avoid prolonged sitting, especially on hard surfaces</li>
                        </ul>
                    </div>
                    ...
                    <div class="info-section">
                        <h3>🧴 DIY Remedies</h3>
                        <ul>
                            <li>Warm sitz bath (warm water soak) for 10–15 minutes after stool</li>
                            <li>Apply coconut oil or aloe vera gel gently to soothe area</li>
                            <li>Use soft, moist wipes instead of rough toilet paper</li>
                        </ul>
                    </div>
                </div>
                ...
                <div id="elderly" class="age-content">
                    <div class="info-section">
                        <h3>👵🧓 Hemorrhoids in Older People</h3>
                        <p>Older adults often face hemorrhoids due to constipation, weaker veins, and less physical activity.</p>
                    </div>
                    ...
                    <div class="info-section">
                        ...
                        <ul>
                            <li>Avoid straining during bowel movements.</li>
                            <li>Don't sit for long periods; use cushions if needed.</li>
                            <li>Maintain good hygiene of the anal area.</li>
                            <li>Avoid heavy lifting and strenuous exercises.</li>
                            <li>Stay hydrated to keep stools soft.</li>
                        </ul>
                    </div>
                    ...
                    <div class="info-section">
                        ...
                        <div class="timing-plan">
                            <div class="time-item">
                                <strong>7:00 AM | Early Morning:</strong>
                                <p>Warm water with soaked flaxseeds or soaked figs</p>
                            </div>
                            <div class="time-item">
                                <strong>8:30 AM | Breakfast:</strong>
                                <p>Oatmeal or soft porridge with fruits like apple or papaya<br>Herbal tea (ginger or chamomile)</p>
                            </div>
                            <div class="time-item">
                                <strong>11:00 AM | Mid-Morning Snack:</strong>
                                <p>Handful of soaked almonds or walnuts<br>Fresh fruit (pear or orange)</p>
                            </div>
                            <div class="time-item">
                                <strong>1:30 PM | Lunch:</strong>
                                <p>Lentil soup or moong dal<br>Steamed vegetables (spinach, bottle gourd)<br>Brown rice or soft chapati</p>
                            </div>
                            <div class="time-item">
                                <strong>4:00 PM | Evening Snack:</strong>
                                <p>Roasted pumpkin or sunflower seeds<br>Coconut water or herbal tea</p>
                            </div>
                            <div class="time-item">
                                <strong>7:00 PM | Dinner:</strong>
                                <p>Vegetable khichdi or soup<br>Boiled or steamed vegetables</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="info-section">
                        <h3>🏃 Exercises</h3>
                        <ul>
                            <li>Gentle walking daily for 20–30 minutes</li>
                            <li>Pelvic floor exercises (Kegel)</li>
                            <li>Avoid heavy lifting or long sitting</li>
                        </ul>
                    </div>
                    ...
                    <div class="info-section">
                        ...
                        <ul>
                            ...
                            <li>Aloe vera gel or coconut oil application for relief</li>
                            <li>Use cold compress to reduce swelling</li>
                            <li>Witch hazel pads for soothing irritation</li>
                        </ul>
                    </div>
                </div>
            </div>
