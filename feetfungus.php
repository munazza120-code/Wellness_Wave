...
<body>
    ...
    <div id="adults" class="age-content active">
        ...
        <div class="info-section">
            ...
            <div class="timing-plan">
                ...
                <div class="time-item">
                    ...
                    <p>Light dinner – vegetable soup, steamed vegetables, or grilled fish/chicken</p>
                </div>
                <div class="time-item">
                    <strong>Tips:</strong>
        ...
        <div class="info-section">
            ...
            <ul>
                <li>Walk daily for 20–30 minutes to improve blood flow</li>
        ...
        <div class="info-section">
            ...
            <ul>
                ...
                <li>Baking Soda Paste: Make a thick paste with water and apply to the affected areas. Let it sit for 10–15 minutes and rinse off</li>
